...
abstract class IAttendanceRemoteDatasourceImpl {
  ...
  Future<void> clearAttendance(AttendanceResponse attendanceResponse, String token, String endpoint);
  Future<void> deleteAttendance(int id, String token, String endpoint);
}
